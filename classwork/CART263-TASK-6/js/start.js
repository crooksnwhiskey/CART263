...
async function getMicrophoneInput() {
    ...
    try {
        ...
        let microphoneIn = audioContext.createMediaStreamSource(stream);
        ...
        function mic() {
            ...
            micFrequency = sum / bufferLength;
            micFrequency = dataArray[20]
...
function go_all_stuff() {
    ...
    drawingBoardC.addObj(new FreeStyleObj(50, 130, 300, "#CF9FFF", "#CF9FFF", drawingBoardC.context))
    ...
    function animationLoop() {
        ...
        drawingBoardB.animate(micVolume, micFrequency);
