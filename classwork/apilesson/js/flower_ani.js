// Declare these globally so all functions can see them
let context;
let startAngle = 0;
...
function animate() {
    ...
    // To see movement, you would usually clear the canvas 
    // and redraw the flower with slightly different values here.
